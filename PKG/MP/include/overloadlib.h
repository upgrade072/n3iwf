...
/* For EMG FEP */
#define OVLD_CTRL_SVC_RADIUS_AUTH				0   /* RADIUS_AUTH OP : PEAP / MAC */
#define OVLD_CTRL_SVC_RADIUS_ACNT_ACCESS		1   /* RADIUS_ACNT OP : ACCOUNT_ON ACCOUNT_OFF STATUS_SERVER */
#define OVLD_CTRL_SVC_RADIUS_ACNT_STATUS		2   /* RADIUS_ACNT OP : ACCOUNT_START ACCOUNT_INTERIM ACCOUNT_STOP */
#define OVLD_CTRL_SVC_HTTP						3   /* HTTP IF service, OP : ?? */

/* For EMG BEP */
#define OVLD_CTRL_SVC_DB_ACC		0    
